...
export const AppReducer = (state, action) => {
    ...
    switch (action.type) {
        ...
        case 'CHG_CURRENCY':
            ...
            if(state.currency === '$'){
                state.currencyName = 'Currency($ Dollar)';
            }
            if(state.currency === '₹'){
                state.currencyName = 'Currency(₹ Rupee)';
            }
            if(state.currency === '€'){
                state.currencyName = 'Currency(€ Euro)';
            }
            if(state.currency === '£'){
                state.currencyName = 'Currency(£ Pound)';
            }
